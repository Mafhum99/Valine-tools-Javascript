...
> **Category**: Math Tools
> **Project Number**: 710
> **Folder**: `710_standard-deviation-calculator`

## 📝 Description
**How it works:** Measures the amount of variation or dispersion in a set of values. Enter data points to calculate the standard deviation.
...
## 📁 File Structure
```
710_standard-deviation-calculator/
