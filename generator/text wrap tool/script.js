...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Text Wrap Tool', icon: '↩️' });
    ...
    // Try to get width from input or use default
    ...
    function calculate() {
        ...
        let result = `═══ Wrap at 40 chars ═══\n\n${wrapText(input, 40)}\n\n`;
        result += `═══ Wrap at 60 chars ═══\n\n${wrapText(input, 60)}\n\n`;
        result += `═══ Wrap at 80 chars ═══\n\n${wrapText(input, 80)}\n\n`;
        result += `═══ Wrap at 120 chars ═══\n\n${wrapText(input, 120)}`;
