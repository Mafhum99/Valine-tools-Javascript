...
/**
 * Text Normalizer
 * Normalize text: lowercase, remove special chars, standardize whitespace
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Text Normalizer', icon: '⚖️' });
    ...
    function calculate() {
        ...
        if (!input) { outputEl.textContent = 'Please enter text to normalize'; return; }
        try {
            let text = input;
