...
> **Category**: Math Tools
> **Project Number**: 719
> **Folder**: `719_normal-distribution-calculator`

## 📝 Description
**How it works:** Calculates probabilities and areas under the normal distribution curve. Enter mean, standard deviation, and value to find probabilities.
...
## 📁 File Structure
```
719_normal-distribution-calculator/
