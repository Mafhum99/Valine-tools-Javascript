...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generate() {
        ...
        const chars = charactersEl.value;
        if (!chars) {
            outputEl.textContent = 'Please provide a character set';
            return;
        }
        ...
        try {
            ...
            for (let i = 0; i < count; i++) {
                strings.push(generateRandomString(length, chars));
            }
            outputEl.textContent = strings.join('\n');
        } catch (error) {
    ...
    function clearFn() {
        lengthEl.value = '16';
        charactersEl.value = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
        countEl.value = '1';
