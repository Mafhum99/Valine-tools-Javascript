...
> **Category**: Math Tools
> **Project Number**: 724
> **Folder**: `724_margin-of-error-calculator`

## 📝 Description
**How it works:** Calculates the margin of error for survey results based on sample size and confidence level.
...
## 📁 File Structure
```
724_margin-of-error-calculator/
