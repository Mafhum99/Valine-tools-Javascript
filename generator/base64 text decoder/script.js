...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Base64 Text Decoder', icon: '🔓' });
    ...
    function calculate() {
        ...
        if (!input) { outputEl.textContent = 'Please enter Base64 data to decode'; return; }
        try {
            // Decode Base64
            ...
            outputEl.textContent = 'Error: Invalid Base64 input - ' + error.message;
        }
    }
