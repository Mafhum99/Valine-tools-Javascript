...
> **Category**: Math Tools
> **Project Number**: 770
> **Folder**: `770_ellipse-equation-calculator`

## 📝 Description
**How it works:** Computes the standard equation of an ellipse from given parameters including center, axes, and foci.
...
## 📁 File Structure
```
770_ellipse-equation-calculator/
