...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Decimal to Binary Converter', icon: '🔢' });
    ...
    function convert() {
        ...
        if (isNaN(num)) {
            outputEl.textContent = 'Error: Invalid input. Please enter a valid number.';
            return;
        }
        ...
        const binary = sign + binaryInt + binaryFrac;

        outputEl.innerHTML = `<strong>Decimal:</strong> ${val}\n<strong>Binary:</strong> ${binary}\n\n<strong>Steps:</strong>\n- Integer part: ${intPart} → ${binaryInt}₂\n- Fractional part: ${intPart !== absNum ? 'calculated to 32 bits' : '0'}\n- Result: ${binary}`;
    }
