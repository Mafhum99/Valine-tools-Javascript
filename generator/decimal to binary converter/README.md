...
> **Category**: Math Tools
> **Project Number**: 801
> **Folder**: `801_decimal-to-binary-converter`

## 📝 Description
**How it works:** Converts decimal (base-10) numbers to their binary (base-2) representations.
...
## 📁 File Structure
```
801_decimal-to-binary-converter/
