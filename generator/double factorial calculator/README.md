...
> **Category**: Math Tools
> **Project Number**: 784
> **Folder**: `784_double-factorial-calculator`

## 📝 Description
**How it works:** Computes the double factorial (n!!) which multiplies every other integer down to 1 or 2.
...
## 📁 File Structure
```
784_double-factorial-calculator/
