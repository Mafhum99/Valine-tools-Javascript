...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Text Statistics', icon: '📊' });
    ...
    function calculate() {
        ...
        try {
            ...
            const avgWordLength = wordCount > 0
                ...
                : 0;
            const readingTimeMin = Math.ceil(wordCount / 200); // ~200 words/min
            const speakingTimeMin = Math.ceil(wordCount / 130); // ~130 words/min
