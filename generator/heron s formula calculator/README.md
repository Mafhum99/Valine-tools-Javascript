...
> **Category**: Math Tools
> **Project Number**: 778
> **Folder**: `778_heron-s-formula-calculator`

## 📝 Description
**How it works:** Calculates the area of a triangle using Heron's formula when all three side lengths are known.
...
## 📁 File Structure
```
778_heron-s-formula-calculator/
