...
> **Category**: Math Tools
> **Project Number**: 836
> **Folder**: `836_pregnancy-due-date-calculator`

## 📝 Description
**How it works:** Estimates the expected due date of pregnancy based on the last menstrual period.
...
## 📁 File Structure
```
836_pregnancy-due-date-calculator/
