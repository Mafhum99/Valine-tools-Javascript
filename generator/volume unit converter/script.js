...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Volume Unit Converter', icon: '🧪' });
    ...
    const units = {
        ...
        'cubic_cm': { name: 'Cubic Centimeter (cm³)', factor: 0.001 },
        'us_gallon': { name: 'US Gallon (gal)', factor: 3.785411784 },
        'us_quart': { name: 'US Quart (qt)', factor: 0.946352946 },
        'us_pint': { name: 'US Pint (pt)', factor: 0.473176473 },
        'us_cup': { name: 'US Cup', factor: 0.2365882365 },
        'us_fl_oz': { name: 'US Fluid Ounce (fl oz)', factor: 0.029573529563 },
        'us_tablespoon': { name: 'US Tablespoon', factor: 0.014786764782 },
        'us_teaspoon': { name: 'US Teaspoon', factor: 0.004928921594 },
        'imperial_gallon': { name: 'Imperial Gallon', factor: 4.54609 },
        'imperial_pint': { name: 'Imperial Pint', factor: 0.56826125 },
        'imperial_fl_oz': { name: 'Imperial Fluid Ounce', factor: 0.0284130625 },
