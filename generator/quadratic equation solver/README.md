...
> **Category**: Math Tools
> **Project Number**: 748
> **Folder**: `748_quadratic-equation-solver`

## 📝 Description
**How it works:** Solves quadratic equations (ax^2 + bx + c = 0) using the quadratic formula, providing real and complex roots.
