...
/**
 * Color Picker
 * Display hex, RGB, HSL, CMYK values with copy buttons
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateColor(hex) {
        ...
        colorValues.innerHTML = values.map(v => `
            <div class="color-value-row">
                <span class="color-label">${v.label}:</span>
                <span>${v.value}</span>
                <button class="btn-copy-small" data-value="${v.value}">Copy</button>
            </div>
        `).join('');

        colorValues.querySelectorAll('.btn-copy-small').forEach(btn => {
