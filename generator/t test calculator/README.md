...
> **Category**: Math Tools
> **Project Number**: 713
> **Folder**: `713_t-test-calculator`

## 📝 Description
**How it works:** Performs t-tests to determine if there is a significant difference between means of two groups. Enter sample data to calculate the t-statistic.
