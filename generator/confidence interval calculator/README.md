...
> **Category**: Math Tools
> **Project Number**: 722
> **Folder**: `722_confidence-interval-calculator`

## 📝 Description
**How it works:** Computes confidence intervals for population parameters based on sample data. Enter sample statistics to calculate the interval.
...
## 📁 File Structure
```
722_confidence-interval-calculator/
