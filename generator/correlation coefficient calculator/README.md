...
> **Category**: Math Tools
> **Project Number**: 715
> **Folder**: `715_correlation-coefficient-calculator`

## 📝 Description
**How it works:** Calculates the Pearson correlation coefficient measuring the strength of linear relationship between two variables.
...
## 📁 File Structure
```
715_correlation-coefficient-calculator/
