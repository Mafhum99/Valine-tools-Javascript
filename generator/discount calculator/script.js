...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculate() {
        ...
        const discountPercent = parseFloat(discountPercentEl.value.trim());

        if (isNaN(originalPrice) || isNaN(discountPercent)) {
            resultsEl.textContent = 'Please enter valid numbers';
            return;
        }
    ...
    if (copyBtn) {
        copyBtn.addEventListener('click', () => {
            copyToClipboard(resultsEl.textContent);
        });
    }

    [originalPriceEl, discountPercentEl].forEach(el => {
