 ...
 * Generate CSS checkerboard patterns
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Checkerboard Pattern Generator', icon: '' });

    const c1 = $('#cb-color1'), c1t = $('#cb-color1-text');
    const c2 = $('#cb-color2'), c2t = $('#cb-color2-text');
    const size = $('#cb-size'), sizeVal = $('#cb-size-value');
    ...
    function gen() {
        const color1 = c1.value, color2 = c2.value;
        ...
        preview.style.backgroundImage = `linear-gradient(45deg, ${color2} 25%, transparent 25%), linear-gradient(-45deg, ${color2} 25%, transparent 25%), linear-gradient(45deg, transparent 75%, ${color2} 75%), linear-gradient(-45deg, transparent 75%, ${color2} 75%)`;
