...
> **Category**: Math Tools
> **Project Number**: 701
> **Folder**: `701_percentage-calculator`

## 📝 Description
**How it works:** Calculates percentages by finding what percentage one number is of another, or calculating a percentage of a given value. Simply input the base number and percentage value to get instant results.
