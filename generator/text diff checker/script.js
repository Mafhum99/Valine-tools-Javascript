...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Text Diff Checker', icon: '\u{1F4CB}' });
        ...
        try {
            ...
            ops.forEach(op => {
                ...
                if (op.type === 'added') {
                    ...
                    sameCount++;
                    html += '<div class="diff-line diff-same">  ' + escaped + '</div>';
                }
            });

            const summary = 'Lines: ' + sameCount + ' unchanged, ' + addedCount + ' added, ' + removedCount + ' removed';
            outputEl.innerHTML = '<div class="diff-summary">' + summary + '</div>' + html;
        } catch (error) {
