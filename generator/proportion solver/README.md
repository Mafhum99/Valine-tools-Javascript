...
> **Category**: Math Tools
> **Project Number**: 705
> **Folder**: `705_proportion-solver`

## 📝 Description
**How it works:** Solves proportion equations by finding the missing value when three values of a proportion are known. Enter the known values to calculate the unknown.
