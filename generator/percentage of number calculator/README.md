...
> **Category**: Math Tools
> **Project Number**: 703
> **Folder**: `703_percentage-of-number-calculator`

## 📝 Description
**How it works:** Computes what a specific percentage of a given number is. Enter the percentage and the base number to find the resulting value.
...
## 📁 File Structure
```
703_percentage-of-number-calculator/
