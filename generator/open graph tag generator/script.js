 ...
 * Generate Open Graph tags for social
 */

// Initialize tool
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Open Graph Tag Generator', icon: '📱' });
    ...
    function calculate() {
        ...
        try {
            ...
            if (type === 'article' && data.author) {
                result += `<meta property="article:author" content="${data.author}">\n`;
                result += `<meta property="article:published_time" content="${data.published || ''}">\n`;
            }
            result += `\n<!-- Twitter -->\n`;
