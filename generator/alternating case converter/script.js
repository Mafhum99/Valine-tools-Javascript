...
/**
 * 517 - Alternating Case Converter
 * Converts text to aLtErNaTiNg CaSe
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Alternating Case Converter', icon: '🔀' });
    ...
    function toAlternatingCase(text, startUpper = true) {
        if (!text) return '';
    ...
    function calculate() {
        ...
        let result = `═══ aLtErNaTiNg CaSe (start lower) ═══\n\n${toAlternatingCase(input, false)}\n\n`;
        result += `═══ AlTeRnAtInG cAsE (start upper) ═══\n\n${toAlternatingCase(input, true)}`;
