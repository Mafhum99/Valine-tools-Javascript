...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculate() {
        ...
        if (!input) {
            outputEl.textContent = 'Please enter a date (e.g., 2024-01-15)';
            return;
        }
        ...
        try {
            ...
            const result = [
                ...
                `ISO Week Number: ${weekNum}`,
                `ISO Week Year: ${weekYear}`,
                `Day of Week: ${dayOfWeek} (${dayNum})`,
                `Week format: W${String(weekNum).padStart(2, '0')}-${weekYear}`
            ].join('\n');
