...
> **Category**: Math Tools
> **Project Number**: 761
> **Folder**: `761_polar-to-rectangular-converter`

## 📝 Description
**How it works:** Converts complex numbers or coordinates from polar form (r, theta) to rectangular form (x, y).
...
## 📁 File Structure
```
761_polar-to-rectangular-converter/
