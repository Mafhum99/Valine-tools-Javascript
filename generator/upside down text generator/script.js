...
/**
 * 534 - Upside Down Text Generator
 * Flips text upside down using Unicode characters
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Upside Down Text Generator', icon: '🙃' });
    ...
    function calculate() {
        ...
        try {
            const result = flipText(input);
            let output = '═══ Upside Down Text ═══\n\n';
            output += result;
            output += `\n\n═══ Original ═══\n\n`;
            output += input;
