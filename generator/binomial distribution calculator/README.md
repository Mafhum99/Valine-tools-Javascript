...
> **Category**: Math Tools
> **Project Number**: 720
> **Folder**: `720_binomial-distribution-calculator`

## 📝 Description
**How it works:** Computes binomial distribution probabilities for a given number of trials and success probability.
...
## 📁 File Structure
```
720_binomial-distribution-calculator/
