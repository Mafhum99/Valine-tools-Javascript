...
> **Category**: Math Tools
> **Project Number**: 773
> **Folder**: `773_hyperbolic-function-calculator`

## 📝 Description
**How it works:** Calculates hyperbolic functions (sinh, cosh, tanh) and their inverses for given values.
...
## 📁 File Structure
```
773_hyperbolic-function-calculator/
