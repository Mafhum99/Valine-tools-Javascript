...
> **Category**: Math Tools
> **Project Number**: 802
> **Folder**: `802_hexadecimal-to-decimal-converter`

## 📝 Description
**How it works:** Converts hexadecimal (base-16) numbers to decimal (base-10) values.
...
## 📁 File Structure
```
802_hexadecimal-to-decimal-converter/
