...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'CSS Button Generator', icon: '\u{1F518}' });
    ...
    function generate() {
        ...
        preview.style.padding = `${p} ${parseInt(p) * 2}px`;
        ...
        const hoverBg = `#${r.toString(16).padStart(2,'0')}${g.toString(16).padStart(2,'0')}${b.toString(16).padStart(2,'0')}`;
    ...
    border: none;
    border-radius: ${br};
    padding: ${p} ${parseInt(padding.value) * 2}px;
    font-size: 1rem;
    font-weight: 600;
    cursor: pointer;
...
.custom-button:hover {
    ...
    function clear() {
        ...
        bgColor.value = '#2563eb'; bgColorText.value = '#2563eb';
        textColor.value = '#ffffff'; textColorText.value = '#ffffff';
        borderRadius.value = 8; borderRadiusVal.textContent = '8px';
        padding.value = 12; paddingVal.textContent = '12px';
    ...
    [bgColor, bgColorText, textColor, textColorText].forEach(el => el.addEventListener('input', generate));
    borderRadius.addEventListener('input', generate);
    padding.addEventListener('input', generate);
    btnText.addEventListener('input', generate);
