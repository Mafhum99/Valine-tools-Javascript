...
/**
 * 541 - Superscript Generator
 * Generates text using superscript Unicode characters
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Superscript Generator', icon: 'ˢᵘᵖ' });
    ...
    function calculate() {
        ...
        try {
            let output = '═══ Superscript Text ═══\n\n';
            output += toSuperscript(input);
            output += '\n\n═══ Original ═══\n\n';
            output += input;
