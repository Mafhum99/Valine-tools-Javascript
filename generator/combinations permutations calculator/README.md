...
> **Category**: Math Tools
> **Project Number**: 718
> **Folder**: `718_combinations-permutations-calculator`

## 📝 Description
**How it works:** Calculates the number of possible combinations or permutations of items taken from a larger set.
...
## 📁 File Structure
```
718_combinations-permutations-calculator/
