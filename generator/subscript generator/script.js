...
/**
 * 542 - Subscript Generator
 * Generates text using subscript Unicode characters
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Subscript Generator', icon: 'ₛᵤ₆' });
    ...
    function calculate() {
        ...
        try {
            let output = '═══ Subscript Text ═══\n\n';
            output += toSubscript(input);
            output += '\n\n═══ Original ═══\n\n';
            output += input;
