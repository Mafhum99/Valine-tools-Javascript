...
> **Category**: Math Tools
> **Project Number**: 799
> **Folder**: `799_base-conversion-calculator`

## 📝 Description
**How it works:** Converts numbers between different number bases (binary, octal, decimal, hexadecimal).
...
## 📁 File Structure
```
799_base-conversion-calculator/
