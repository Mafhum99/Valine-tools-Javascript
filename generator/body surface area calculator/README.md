...
> **Category**: Math Tools
> **Project Number**: 835
> **Folder**: `835_body-surface-area-calculator`

## 📝 Description
**How it works:** Calculates body surface area (BSA) from height and weight for medical applications.
...
## 📁 File Structure
```
835_body-surface-area-calculator/
