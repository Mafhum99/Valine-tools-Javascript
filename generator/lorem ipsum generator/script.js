...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generate() {
        let count = parseInt(paragraphsEl.value, 10);
    ...
    function clearFn() {
        paragraphsEl.value = '3';
        typeEl.value = 'paragraphs';
