...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Angle Converter', icon: '📐' });
    ...
    const units = {
        ...
        'turn': { name: 'Turn (revolution)', factor: 360 },
        'milliradian': { name: 'Milliradian (mrad)', factor: 180 / (Math.PI * 1000) }
    };
