 ...
 * Convert RGB (0-255) to HEX color code
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'RGB to Hex Converter', icon: '\uD83D\uDD04' });
    ...
    function convert() {
        ...
        resultGrid.innerHTML = `
            ...
            <div class="result-item">
                <span class="result-item-label">RGB</span>
                <span class="result-item-value">rgb(${r}, ${g}, ${b})</span>
            </div>
        `;
    }
