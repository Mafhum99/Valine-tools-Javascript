...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Time Unit Converter', icon: '⏱️' });
    ...
    const units = {
        ...
        'microsecond': { name: 'Microsecond (μs)', factor: 1e-6 },
