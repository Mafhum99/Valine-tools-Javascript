...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Days Between Dates Calculator', icon: '📅' });
    ...
    const weekends = weeks * 2;
    const businessDays = days - weekends;
    
    outputEl.textContent = 'Between:\n' +
      ...
      'Business Days (Mon-Fri): ' + businessDays.toLocaleString() + '\n' +
      'Weekend Days: ' + weekends.toLocaleString();
