...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'SHA-256 Generator', icon: '🔏' });
    ...
    generateSHA256(input).then(hash => { outputEl.textContent = hash; });
    ...
    calculateBtn.addEventListener('click', async () => { (async () => { await calculate(); })());
