...
> **Category**: Math Tools
> **Project Number**: 721
> **Folder**: `721_poisson-distribution-calculator`

## 📝 Description
**How it works:** Calculates Poisson distribution probabilities for events occurring at a known average rate.
...
## 📁 File Structure
```
721_poisson-distribution-calculator/
