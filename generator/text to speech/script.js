...
/**
 * Text to Speech
 * Convert text to speech using SpeechSynthesisUtterance API
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Text to Speech', icon: '🔊' });
    ...
    rateEl.addEventListener('input', () => {
        rateValueEl.textContent = parseFloat(rateEl.value).toFixed(1);
    });

    pitchEl.addEventListener('input', () => {
        pitchValueEl.textContent = parseFloat(pitchEl.value).toFixed(1);
    });
