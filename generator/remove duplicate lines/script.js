...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Remove Duplicate Lines', icon: '🧹' });
    ...
    function removeDuplicates() {
        ...
        try {
            ...
            const doTrim = trimLinesEl.checked;
            ...
            statsEl.textContent = `${unique.length} lines (${removed} duplicates removed)`;
            outputEl.textContent = unique.join('\n');
        } catch (error) {
