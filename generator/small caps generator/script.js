...
/**
 * 540 - Small Caps Generator
 * Generates text using small caps Unicode characters
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Small Caps Generator', icon: 'ᴀ' });
    ...
    function calculate() {
        ...
        try {
            let output = '═══ Small Caps Text ═══\n\n';
            output += toSmallCaps(input);
            output += '\n\n═══ Original ═══\n\n';
            output += input;
