 ...
 * Monthly payment: loanAmount * (r*Math.pow(1+r,n)) / (Math.pow(1+r,n)-1)
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Amortization Schedule Generator', icon: '🧮' });

    const loanAmountEl = $('#loan_amount');
    const annualRateEl = $('#annual_rate');
    const termMonthsEl = $('#term_months');
    ...
    [loanAmountEl, annualRateEl, termMonthsEl].forEach(el => {
