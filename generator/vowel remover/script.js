...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Vowel Remover', icon: '🔤' });
    ...
    function removeVowels(text, keepY = false) {
        const pattern = keepY ? /[aeiouAEIOU]/g : /[aeiouAEIOUyY]/g;
        return text.replace(pattern, '');
    }

    function removeOnlyLowerVowels(text) {
        return text.replace(/[aeiou]/g, '');
    }

    function removeOnlyUpperVowels(text) {
        return text.replace(/[AEIOU]/g, '');
    }

    function replaceVowelsWith(text, replacement) {
        return text.replace(/[aeiouAEIOU]/g, replacement);
    }
    ...
    function calculate() {
        ...
        try {
            let output = '═══ Vowel Removal Results ═══\n\n';

            output += '═══ Remove All Vowels (a,e,i,o,u) ═══\n\n';
            output += removeVowels(input, true);

            output += '\n\n═══ Remove All Vowels + Y ═══\n\n';
            output += removeVowels(input, false);

            output += '\n\n═══ Remove Only Lowercase Vowels ═══\n\n';
            output += removeOnlyLowerVowels(input);

            output += '\n\n═══ Remove Only Uppercase Vowels ═══\n\n';
            output += removeOnlyUpperVowels(input);

            output += '\n\n═══ Replace Vowels with * ═══\n\n';
            output += replaceVowelsWith(input, '*');

            output += '\n\n═══ Replace Vowels with _ ═══\n\n';
            output += replaceVowelsWith(input, '_');
