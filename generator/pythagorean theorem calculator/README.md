...
> **Category**: Math Tools
> **Project Number**: 747
> **Folder**: `747_pythagorean-theorem-calculator`

## 📝 Description
**How it works:** Solves right triangle problems using the Pythagorean theorem (a^2 + b^2 = c^2).
...
## 📁 File Structure
```
747_pythagorean-theorem-calculator/
