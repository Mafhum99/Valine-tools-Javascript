...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Power Converter', icon: '💪' });
    ...
    const units = {
        ...
        'horsepower_mech': { name: 'Mechanical HP (hp)', factor: 745.69987158 },
        'horsepower_metric': { name: 'Metric HP (PS)', factor: 735.49875 },
        'horsepower_elec': { name: 'Electric HP', factor: 746 },
        'btu_per_hr': { name: 'BTU/hour', factor: 0.29307107 },
        'footpound_per_sec': { name: 'Foot-pound/second', factor: 1.3558179483 },
        'footpound_per_min': { name: 'Foot-pound/minute', factor: 0.0225969658 },
        'calorie_per_sec': { name: 'Calorie/second', factor: 4.184 }
    };
    ...
    fromEl.value = 'kilowatt';
    toEl.value = 'horsepower_mech';
