...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Energy Converter', icon: '⚡' });
    ...
    const units = {
        ...
        'therm': { name: 'Therm (US)', factor: 105480400 },
    ...
    fromEl.value = 'kilocalorie';
    toEl.value = 'kilojoule';
