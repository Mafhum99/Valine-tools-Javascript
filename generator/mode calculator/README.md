...
> **Category**: Math Tools
> **Project Number**: 708
> **Folder**: `708_mode-calculator`

## 📝 Description
**How it works:** Identifies the most frequently occurring value(s) in a dataset. Enter numbers to find the mode(s) of the distribution.
