...
document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Area Unit Converter', icon: '📐' });
    ...
    const units = {
        ...
        'sq_kilometer': { name: 'Square Kilometer (km²)', factor: 1e6 },
        'sq_centimeter': { name: 'Square Centimeter (cm²)', factor: 1e-4 },
        'sq_millimeter': { name: 'Square Millimeter (mm²)', factor: 1e-6 },
        'sq_mile': { name: 'Square Mile (mi²)', factor: 2589988.110336 },
        'sq_yard': { name: 'Square Yard (yd²)', factor: 0.83612736 },
        'sq_foot': { name: 'Square Foot (ft²)', factor: 0.09290304 },
        'sq_inch': { name: 'Square Inch (in²)', factor: 0.00064516 },
