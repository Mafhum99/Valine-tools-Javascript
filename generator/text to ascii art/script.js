...
/**
 * 532 - Text to ASCII Art Converter
 * Converts text to ASCII art using built-in character maps
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Text to ASCII Art Converter', icon: '🎨' });
