...
/**
 * Pomodoro Timer
 * 25min work / 5min break, start/pause/reset, shows current phase, rounds completed
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateDisplay() {
        ...
        if (isWork) {
            ...
            phaseName.style.color = '#dc2626';
            phaseIndicator.style.background = '#fef2f2';
        } else {
            phaseName.textContent = 'Break';
            phaseName.style.color = '#10b981';
            phaseIndicator.style.background = '#f0fdf4';
        }
