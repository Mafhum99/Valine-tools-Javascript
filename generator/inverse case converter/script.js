...
/**
 * 518 - Inverse Case Converter
 * Swaps the case of each character
 */

document.addEventListener('DOMContentLoaded', () => {
    initTool({ name: 'Inverse Case Converter', icon: '🔄' });
    ...
    function calculate() {
        ...
        outputEl.textContent = input ? toggleCase(input) : 'Please enter text';
    }
    ...
    inputEl.addEventListener('input', debounce(calculate, 200));
});
